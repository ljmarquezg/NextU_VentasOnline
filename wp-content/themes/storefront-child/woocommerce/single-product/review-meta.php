...
<?php } else { ?>
	...
	<p class="meta">
		...
		?>
		<small class="text-muted">Posteado por <strong><?php comment_author(); ?> </strong> el <span datetime="<?php echo esc_attr( get_comment_date( 'c' ) ); ?>"><?php echo esc_html( get_comment_date( wc_date_format() ) ); ?></span></small>
	</p>
